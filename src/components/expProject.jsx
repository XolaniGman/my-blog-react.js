    ...
    <div class="exp">
            <img src={item.image} alt="" />
                    ...
                    <li>{item.test4}</li>
                     ...
                     <div class="social">
                        <a href="https://www.linkedin.com/company/level-up-medical/"><img src={social} alt=""/></a>
                        <a href="https://www.linkedin.com/company/level-up-medical/"><img src={social1} alt=""/></a>
                        <img src={social2} alt=""/>
                        <img src={social3} alt=""/>
